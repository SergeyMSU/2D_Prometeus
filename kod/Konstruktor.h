...
public:
	...
	void print_Tecplot_y_20(double y, double T, string nam = "g");
	void print_Tecplot_z_20(double z, double T, string nam = "g");
	void print_Tecplot_x_20(double x, double T, string nam = "g");
	...
	void Drobim(double x1, double x2, double y1, double y2, double z1, double z2, int NN);
	void Drobim(double x0, double y0, double z0, double r1, double r2, int NN, bool ff);
	void Drobim(double x1, double x2, double r, int NN);
